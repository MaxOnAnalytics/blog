...
![](assets/20200323/Kobe Bryant Picture.jpg)
...
kobe_by_zone_year_pct_bar <- ggplot(kobe_by_zone_year, aes(x = season_year, y = pct_of_season)) + 
  ...
  facet_wrap(~shot_zone_basic, ncol = 2) + 
...
winning_time_shots <- kobe_shots %>%
  filter((period == 4 & minutes_remaining < 5) | period > 4)

create_heat_map_outside_restricted(winning_time_shots, 1996, 2015)
