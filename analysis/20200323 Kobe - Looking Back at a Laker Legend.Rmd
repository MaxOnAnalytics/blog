...
<img width="48%" src="/docs/assets/20200323/Kobe Bryant Shots 1996-1997.gif"/>
<img width="48%" src="/docs/assets/20200323/Kobe Bryant Shots 2000-2001.gif"/>
<img width="48%" src="/docs/assets/20200323/Kobe Bryant Shots 2007-2008.gif"/>
<img width="48%" src="/docs/assets/20200323/Kobe Bryant Shots 2015-2016.gif"/>
...
kobe_fg_pct_table <- tbl_df(kobe_fg_pct %>% rename(`Shot Distance (ft)` = shot_distance, `FG%` = fg_pct, 
                                                   `EFG%` = efg_pct, `Points per Shot` = pps, 
                                                   `Total Shots` = total_shots, 
                                                   `Percent of Total Shots` = pct_of_total))
kobe_fg_pct_table
...
kobe_by_zone_qtr %>% 
  ...
  rename(`FG%` = fg_pct, `EFG%` = efg_pct, `Points per Shot` = pps, 
