...
![](assets/20200426/Kobe Bryant Picture.jpg)
...
On January 26, 2020, Kobe, his daughter Gianna, and seven others tragically lost their lives in a helicopter crash in Calabasas, California. In the aftermath of this horrible loss, we have seen countless tributes to Kobe the player and Kobe the person, and it is clear how many lives he impacted and how many people respected and admired him. We have seen so many clips of his greatest moments - the high-flying dunks as a teenager in his first couple years in the league, his 81 point explosion against the Toronto Raptors in 2006, and finally the "Mamba Out" game, in which he dropped 60 points in the final game of his career against the Utah Jazz in 2016. I couldn't get enough Kobe content, so I decided to dig into his regular season shot data from 1996 to 2016 to research how his game evolved as his career went on, and to provide a quick little tool that can be used to look back at any Kobe Bryant performance through data visualization. 


# Shot Charts and Gifs 

Kobe Bryant took 26,200 shots over the course of his career during the regular season. He shot 44.7% from the field, 32.9% from 3, and scored 33,643 points for an average of 25.0 per game. 
...
source("./code/20200426/court_themes.R")
source("./code/20200426/plot_court.R")
source("./code/20200426/players_data.R")
source("./code/20200426/fetch_shots.R")
...
![](assets/20200426/Kobe Bryant Shots 1996-1997.gif)

</div>

<div class = "col-md-6">

![](assets/20200426/Kobe Bryant Shots 2000-2001.gif)
...
![](assets/20200426/Kobe Bryant Shots 2007-2008.gif)

</div>

<div class = "col-md-6">

![](assets/20200426/Kobe Bryant Shots 2015-2016.gif)
...
#          `Points per Shot` = pps, `Total Shots` = total_shots, `Percent of Career Shots` = pct_of_career) %>%
#   as.data.frame()
...
create_heat_map_outside_restricted(winning_time, start_year = 1996, end_year = 2015, 
